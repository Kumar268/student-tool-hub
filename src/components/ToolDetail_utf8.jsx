...
// Γòæ  ToolDetail.jsx ΓÇö CLEAN AD MANAGEMENT                          Γòæ
// Γòæ  ΓÇó All ads controlled HERE only ΓÇö never inside tool components  Γòæ
// Γòæ  ΓÇó Ad sanitizer strips ad nodes from tool output               Γòæ
// Γòæ  ΓÇó Responsive, clean, professional layout                       Γòæ
...
// ΓöÇΓöÇΓöÇ YOUR PUBLISHER ID ΓÇö change this one place only ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const ADSENSE_CLIENT = 'ca-pub-XXXXXXXXXXXXXXXX';

// ΓöÇΓöÇΓöÇ AD SLOT IDs ΓÇö change these to your real slot IDs ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const AD_SLOTS = {
  top:    '1111111111',   // leaderboard / responsive ΓÇö above tool
  bottom: '2222222222',   // leaderboard / responsive ΓÇö below tool
  sidebar:'3333333333',   // rectangle ΓÇö sidebar (if you add one later)
};
...
// Labelled ad wrapper ΓÇö shows "Advertisement" label above the ins tag
...
// This is a DOM operation ΓÇö zero risk of breaking tool logic.
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
...
function sanitizeAds(containerEl) {
  ...
  containerEl.querySelectorAll('div, p, span').forEach(el => {
    ...
    if (text.length < 120) { // only check short strings ΓÇö not entire tool content
      const isAdPlaceholder = AD_TEXT_HINTS.some(hint => text.includes(hint));
      if (isAdPlaceholder && el.children.length === 0) {
        // It's a leaf text node with ad text ΓÇö remove
        el.remove();
      }
    }
  });
...
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
// ERROR BOUNDARY ΓÇö wraps every lazy tool
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
...
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
// TOAST SYSTEM ΓÇö replaces all alert() calls
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
  ...
  return (
    <div style={{
      ...
      <motion.div
        ...
        {/* Copy URL ΓÇö FIX: uses toast instead of alert() */}
        <div style={{
...
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
// RELATED TOOLS ΓÇö same category, max 4, excludes current
...
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
// LAZY TOOL MAP ΓÇö unchanged from original
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
...
const ToolDetail = ({ isDarkMode }) => {
  ...
  // ΓöÇΓöÇ All state declared BEFORE any conditional returns (hooks rule) ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Tool lookup ΓÇö after all hooks ΓöÇΓöÇ
  ...
  const copyResult = useCallback((result) => {
    ...
    navigator.clipboard.writeText(String(result))
      ...
      .catch(() => addToast('Could not copy ΓÇö please copy manually.', 'error'));
  }, [addToast]);

  // FIX: PDF libs loaded lazily ΓÇö not bundled on every page load
  const handleDownloadPDF = useCallback(async () => {
    ...
    try {
      ...
      console.error(err);
      addToast('PDF failed. Try Print ΓåÆ Save as PDF instead.', 'error');
    } finally {
      setPdfLoading(false);
    }
  ...
  const handleShare = useCallback(async () => {
    ...
    if (navigator.share && /Android|iPhone|iPad/i.test(navigator.userAgent)) {
      try {
        ...
        return;
      } catch { /* user cancelled ΓÇö fall through to modal */ }
    }
    setShareOpen(true);
  }, [tool]);
  ...
  return (
    <>
      <Helmet>
        <title>{`${tool.name} ΓÇö Free Online Tool | StudentToolHub`}</title>
        <meta name="description" content={tool.description} />
        <meta name="keywords" content={[tool.name, ...(tool.tags || [])].join(', ')} />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:title"       content={`${tool.name} ΓÇö StudentToolHub`} />
      ...
      <div style={pageStyle} className={`${dk ? 'dark' : 'light'} crystal-scene`}>
        ...
        {/* Ambient Glow Orbs ΓÇö purely visual, disabled on mobile */}
        ...
        {/* ΓöÇΓöÇ HEADER CONTAINER (Centered & Readable) ΓöÇΓöÇ */}
          ...
          <motion.div
            ...
            <div style={{ display: 'flex', gap: 7, flexWrap: 'wrap' }} className="preserve-3d">
              ...
              <CrystalBtn onClick={handleDownloadPDF} disabled={pdfLoading}>
                ...
                <span className="hidden-xs">{pdfLoading ? 'SavingΓÇª' : 'PDF'}</span>
              </CrystalBtn>
            </div>
          </motion.div>

          {/* ΓöÇΓöÇ TOOL HEADER ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ TOOL CONTENT CONTAINER (Full Width, Flat for Usability) ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ FOOTER CONTAINER (Centered) ΓöÇΓöÇ */}
        <div style={centeredSectionStyle} className="preserve-3d">
