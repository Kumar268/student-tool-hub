...
import BMIAndCalorie from '@/tools/health/BMIAndCalorie';

function BMIAndCalorieExtras() {
  return (
    <div>
...
export default function BMIAndCaloriePage() {
  return (
    <ToolPageLayout
      title="BMI And Calorie"
      icon="🚀"
      extraFeatures={<BMIAndCalorieExtras />}
