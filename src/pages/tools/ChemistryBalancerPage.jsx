...
import ChemistryBalancer from '@/tools/academic/ChemistryBalancer';

function ChemistryBalancerExtras() {
  return (
    <div>
...
export default function ChemistryBalancerPage() {
  return (
    <ToolPageLayout
      title="Chemistry Balancer"
      icon="🚀"
      extraFeatures={<ChemistryBalancerExtras />}
