...
import EconomicsElasticity from '@/tools/academic/EconomicsElasticity';

function EconomicsElasticityExtras() {
  return (
    <div>
...
export default function EconomicsElasticityPage() {
  return (
    <ToolPageLayout
      title="Economics Elasticity"
      icon="🚀"
      extraFeatures={<EconomicsElasticityExtras />}
