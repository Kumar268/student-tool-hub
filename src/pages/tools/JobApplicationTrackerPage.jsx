...
import JobApplicationTracker from '@/tools/documentmaker/JobApplicationTracker';

function JobApplicationTrackerExtras() {
  return (
    <div>
...
export default function JobApplicationTrackerPage() {
  return (
    <ToolPageLayout
      ...
      icon="🚀"
      extraFeatures={<JobApplicationTrackerExtras />}
