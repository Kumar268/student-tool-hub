...
import MusicTheoryCalc from '@/tools/niche/MusicTheoryCalc';

function MusicTheoryCalcExtras() {
  return (
    <div>
...
export default function MusicTheoryCalcPage() {
  return (
    <ToolPageLayout
      title="Music Theory Calc"
      icon="🚀"
      extraFeatures={<MusicTheoryCalcExtras />}
