...
import PhysicsKinematics from '@/tools/academic/PhysicsKinematics';

function PhysicsKinematicsExtras() {
  return (
    <div>
...
export default function PhysicsKinematicsPage() {
  return (
    <ToolPageLayout
      title="Physics Kinematics"
      icon="🚀"
      extraFeatures={<PhysicsKinematicsExtras />}
