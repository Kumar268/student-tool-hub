...
import ProjectileSimulator from '@/tools/academic/ProjectileSimulator';

function ProjectileSimulatorExtras() {
  return (
    <div>
...
export default function ProjectileSimulatorPage() {
  return (
    <ToolPageLayout
      title="Projectile Simulator"
      icon="🚀"
      extraFeatures={<ProjectileSimulatorExtras />}
