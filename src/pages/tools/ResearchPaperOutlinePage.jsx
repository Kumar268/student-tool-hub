...
import ResearchPaperOutline from '@/tools/documentmaker/ResearchPaperOutline';

function ResearchPaperOutlineExtras() {
  return (
    <div>
...
export default function ResearchPaperOutlinePage() {
  return (
    <ToolPageLayout
      title="Research Paper Outline"
      icon="🚀"
      extraFeatures={<ResearchPaperOutlineExtras />}
