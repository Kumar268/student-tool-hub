...
import LinkedInSummaryGen from '@/tools/documentmaker/LinkedInSummaryGen';

function LinkedInSummaryGenExtras() {
  return (
    <div>
...
export default function LinkedInSummaryGenPage() {
  return (
    <ToolPageLayout
      title="Linked In Summary Gen"
      icon="🚀"
      extraFeatures={<LinkedInSummaryGenExtras />}
