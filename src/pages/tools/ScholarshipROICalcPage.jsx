...
import ScholarshipROICalc from '@/tools/financial/ScholarshipROICalc';

function ScholarshipROICalcExtras() {
  return (
    <div>
...
export default function ScholarshipROICalcPage() {
  return (
    <ToolPageLayout
      title="Scholarship ROI Calc"
      icon="🚀"
      extraFeatures={<ScholarshipROICalcExtras />}
