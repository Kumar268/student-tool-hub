...
import FinalGradeCalc from '@/tools/utility/FinalGradeCalc';

function FinalGradeCalcExtras() {
  return (
    <div>
...
export default function FinalGradeCalcPage() {
  return (
    <ToolPageLayout
      title="Final Grade Calc"
      icon="🚀"
      extraFeatures={<FinalGradeCalcExtras />}
