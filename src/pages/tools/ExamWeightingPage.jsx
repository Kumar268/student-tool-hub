...
import ExamWeighting from '@/tools/utility/ExamWeighting';

function ExamWeightingExtras() {
  return (
    <div>
...
export default function ExamWeightingPage() {
  return (
    <ToolPageLayout
      title="Exam Weighting"
      icon="🚀"
      extraFeatures={<ExamWeightingExtras />}
