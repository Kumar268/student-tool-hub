...
import MatrixAlgebra from '@/tools/academic/MatrixAlgebra';

function MatrixAlgebraExtras() {
  return (
    <div>
...
export default function MatrixAlgebraPage() {
  return (
    <ToolPageLayout
      title="Matrix Algebra"
      icon="🚀"
      extraFeatures={<MatrixAlgebraExtras />}
