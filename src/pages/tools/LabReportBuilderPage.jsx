...
import LabReportBuilder from '@/tools/documentmaker/LabReportBuilder';

function LabReportBuilderExtras() {
  return (
    <div>
...
export default function LabReportBuilderPage() {
  return (
    <ToolPageLayout
      title="Lab Report Builder"
      icon="🚀"
      extraFeatures={<LabReportBuilderExtras />}
