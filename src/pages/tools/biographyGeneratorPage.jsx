...
import biographyGenerator from '@/tools/documentmaker/biographyGenerator';

function biographyGeneratorExtras() {
  return (
    <div>
...
export default function biographyGeneratorPage() {
  return (
    <ToolPageLayout
      title="biography Generator"
      icon="🚀"
      extraFeatures={<biographyGeneratorExtras />}
