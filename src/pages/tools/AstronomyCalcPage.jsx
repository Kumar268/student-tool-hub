...
import AstronomyCalc from '@/tools/niche/AstronomyCalc';

function AstronomyCalcExtras() {
  return (
    <div>
...
export default function AstronomyCalcPage() {
  return (
    <ToolPageLayout
      title="Astronomy Calc"
      icon="🚀"
      extraFeatures={<AstronomyCalcExtras />}
