...
import StudentBudgeting from '@/tools/financial/StudentBudgeting';

function StudentBudgetingExtras() {
  return (
    <div>
...
export default function StudentBudgetingPage() {
  return (
    <ToolPageLayout
      title="Student Budgeting"
      icon="🚀"
      extraFeatures={<StudentBudgetingExtras />}
