...
import ScholarshipLatter from '@/tools/documentmaker/ScholarshipLatter';

function ScholarshipLatterExtras() {
  return (
    <div>
...
export default function ScholarshipLatterPage() {
  return (
    <ToolPageLayout
      title="Scholarship Latter"
      icon="🚀"
      extraFeatures={<ScholarshipLatterExtras />}
